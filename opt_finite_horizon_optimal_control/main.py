...
# -*- coding: utf-8 -*- 
u""" 
Finite Horizon Optimal Control with optimization
...
def CalcFiniteHorizonOptimalInputWithOpt(A,B,Q,R,P,N,x0):
    u"""
    ...
    sol=cvxopt.solvers.qp(matrix(P),matrix(q.T))
    uopt=sol["x"]
...
if __name__ == '__main__':
    ...
    uopt=CalcFiniteHorizonOptimalInputWithOpt(A,B,Q,R,P,N,x0)
